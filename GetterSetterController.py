...
#              this class imitates a window proceedure function in
#              Win32.
#
...
class Controller:
    ...
    def __init__( self ):
        """ Default Constructor: Define Model & View components of the
            MVC architecture """

        App = wx.App(redirect=False)  #True)  # Error messages go to popup window

        self.app_window = GetterSetterView ( None, self, wx.Point(10,10), wx.Size(600,600), wx.VERTICAL ) # HORIZONTAL )
