#-------------------------------------------------------------------------------
# Name:        Getter Setter Application - Regression Test
#
...
if __name__ == "__main__":
    ...
    test_dirs = ((os.getcwd() + "\Getter Setter Test Files\\TestC++Files",    ".h"),
                 (os.getcwd() + "\Getter Setter Test Files\\TestJavaFiles",   ".java"),
                 (os.getcwd() + "\Getter Setter Test Files\\TestPythonFiles", ".py") )
    
    create_log_file( "GetterSetterLog.rtf" )

    test_sols = parse_solution_file_ex( os.getcwd() + "//TestSolutions.rtf" )
    
    for di in test_dirs:

        test_find_variables( di, "GetterSetterLog.rtf", "TestSolutions.rtf", test_sols )
