...
# Purpose:     This class is responsible for parsing the source code of a file
#              & identifing the variables within each wrapper found in the source
#              code. This class utilises sub-classing to overcome the different
#              programming language formats in order to parse the code for
#              variables.
#
...
class SourceCode:
    ...
    def format_var( self, var_str ):
        ...
        var_str = str( var_str )
        return var_str.translate(str.maketrans('','',"\t\r\n\v:;,{}(+-/=~?" )).strip()
