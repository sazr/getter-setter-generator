...
# Purpose:     A class that models different programming language variables
#              (through polymorphism). Each variable is responsible for
#              generating its own getter/setter functions(code).
#
...
from GetterSetterGlobal import BOTH, GETTER, SETTER, CPLUSPLUS, JAVA, PYTHON
